...
# model = FastText(tokenized, vector_size=10, min_count=5, epochs=40)
model = FastText(tokenized, vector_size=10, min_count=1, epochs=100)  # ok radical?
# model = FastText(tokenized, vector_size=5, min_count=1, epochs=40)    # ok
# model = FastText(tokenized, vector_size=5, min_count=1, epochs=100)    # ok radical?
# model = FastText(tokenized, vector_size=20, min_count=1, epochs=40)    # ok
# model = FastText(tokenized, vector_size=20, min_count=1, epochs=100)    # ok radical?
